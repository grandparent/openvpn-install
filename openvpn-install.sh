#!/bin/bash
#OpenVPN + Freeradius Installer for Ubuntu 16.04
# Modified for ApolloNode, Originally made by https://github.com/Nyr
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	clear
	echo 'Welcome to the ApolloNode OpenVPN + FreeRadius Installer'
	echo ""
	# OpenVPN setup and first user creation
	echo "Just a few options before we start. "
	...
	echo ""
	echo "Please tell me the IP of your master freeradius server."
	read -p "Freeradius Server: " -e radiusip
	echo ""
	echo "Please tell me the Shared Secret you wish to set for this server."
	echo "This will need to be the same as the shared secret you set in your freeradius clients.conf file."
	read -p "Freeradius Shared Secret: " -e radiussecret
	echo ""
...
verb 3" > /etc/openvpn/client-common.txt
	...
	echo "Finished!"
	echo ""
	echo "The config file is located @ /root/"
	echo "All that's left to do is configure your freeradius master server to accept this server."
fi